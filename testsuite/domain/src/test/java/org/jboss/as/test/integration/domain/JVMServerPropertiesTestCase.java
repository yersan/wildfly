...
public class JVMServerPropertiesTestCase {
    ...
    public static WebArchive createDeployment() {
        ...
        war.addAsManifestResource(createPermissionsXmlAsset(
                new PropertyPermission("test.jboss.server.base.dir", "read"),
                new PropertyPermission("test.jboss.server.log.dir", "read"),
                new PropertyPermission("test.jboss.server.data.dir", "read"),
                new PropertyPermission("test.jboss.server.temp.dir", "read")
        ), "permissions.xml");
