...
//    void phaseListenersConfigParseFailed(VirtualFile facesConfig);
    ...
    @Message(id = 17, value = "Jakarta Server Faces 1.2 classes detected. Using org.jboss.as.jsf.injection.weld.legacy.WeldApplicationFactoryLegacy.")
    void loadingJsf12();

    @LogMessage(level = DEBUG)
    @Message(id = 18, value = "Jakarta Server Faces 1.2 classes not detected. Using org.jboss.as.jsf.injection.weld.WeldApplicationFactory.")
    void loadingJsf2x();
