...
public class SomeExtension implements Extension {
    ...
    static void registerTransformers(final SubsystemTransformerRegistration subsystem) {
     ...
     */
    private static void registerTransformers_1_1_0(final SubsystemTransformerRegistration subsystem) {
...
[source,java,options="nowrap"]
----
    private void registerTransformers(SubsystemTransformerRegistration subsystem) {
...
[source,java,options="nowrap"]
----
    private void initializeTransformers_1_1_0(SubsystemTransformerRegistration subsystemRegistration) {
        ResourceTransformationDescriptionBuilder builder = TransformationDescriptionBuilder.Factory.createSubsystemInstance();
        builder.getAttributeBuilder()
            .setDiscard(
...
[source,java,options="nowrap"]
----
    private static void registerTransformers_1_1_0(SubsystemTransformerRegistration subsystemRegistration) {
        ResourceTransformationDescriptionBuilder builder = TransformationDescriptionBuilder.Factory.createSubsystemInstance()
                .getAttributeBuilder()
                 //...
...
public class SomeExtension implements Extension {
    ...
    private void registerTransformers(final SubsystemTransformerRegistration subsystem) {
     ...
     */
    private void registerTransformers_1_0_0(SubsystemTransformerRegistration subsystem) {
        ResourceTransformationDescriptionBuilder builder = TransformationDescriptionBuilder.Factory.createSubsystemInstance();
        builder.getAttributeBuilder()
...
----
     ...
     * Registers transformers from the current version to ModelVersion 1.1.0
     */
    private void registerTransformers_1_1_0(SubsystemTransformerRegistration subsystem) {
        ResourceTransformationDescriptionBuilder builder = TransformationDescriptionBuilder.Factory.createSubsystemInstance();
        builder.getAttributeBuilder()
...
----
    private void registerTransformers(SubsystemTransformerRegistration subsystem) {
        ...
        ChainedTransformationDescriptionBuilder chainedBuilder =
              TransformationDescriptionBuilder.Factory.createChainedSubystemInstance(subsystem.getCurrentSubsystemVersion());

        //Differences between the current version and 1.1.0
        ResourceTransformationDescriptionBuilder builder110 =
            chainedBuilder.createBuilder(subsystem.getCurrentSubsystemVersion(), version1_1_0);
        ...
        ResourceTransformationDescriptionBuilder builder100 =
            chainedBuilder.createBuilder(version1_1_0, version1_0_0);
...
----
    ...
    private void registerTransformers_1_2(SubsystemTransformerRegistration registration) {
